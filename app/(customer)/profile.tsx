...
export default function CustomerProfileScreen() {
  ...
  // Only show guest view if we're sure there's no user
  if (!user) {
    return (
      <AppScreen>
        <View style={styles.guestContainer}>
          ...
          <TouchableOpacity
            ...
            style={[styles.secondaryBtn, { backgroundColor: theme.surfaceVariant, borderColor: theme.border }]}
          >
          ...
          >
            <Text style={[styles.browseLinkText, { color: theme.textMuted }]}>
  ...
  // AUTHENTICATED — render shared ProfileScreen
